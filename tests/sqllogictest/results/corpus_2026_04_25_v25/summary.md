...
| c | 1464745 | 77 | 2124 | 83229 | 1550175 | 94.49% | 99.85% |
| go | 1510449 | 857 | 13214 | 83741 | 1608261 | 93.92% | 99.08% |
| zig | 1573151 | 1940 | 16037 | 99916 | 1691044 | 93.03% | 98.87% |
| python | 1648608 | 92 | 2059 | 134851 | 1785610 | 92.33% | 99.87% |
...
### zig
- 7975	compile: deferred: aggregate in scalar context
- 4880	compile: deferred: compound SELECT head references CTE/view
...
### python
- 709	compile: deferred: correlated EXISTS (Python pre-execute model)
...
### zig
- 716	got(<n>) expected(<n>) first got=<n> expected=<n>
