...
- 26786	parse: unexpected token after SELECT statement
- 3980	compile: unknown table in JOIN: tab0
- 3966	compile: unknown table in JOIN: tab2
- 3913	compile: unknown table in JOIN: tab1
...
- 824	parse: expected '<s>' or '<s>' in argument list
...
### python
- 359146	got=[] expected=['<s>']
- 80583	got=['<s>', '<s>', '<s>'] expected=['<s>', '<s>', '<s>']
- 39531	got=['<s>', '<s>', '<s>', '<s>', '<s>', '<s>', '<s>', '<s>', '<s>', '<s>', '<s>', '<s>', '<s>', '<s>', '<s>', '<s>', '<s...
- 32525	got=['<s>', '<s>', '<s>', '<s>', '<s>', '<s>', '<s>', '<s>', '<s>', '<s>'] expected=['<s>']
- 32289	got=[] expected=['<s>', '<s>']
- 29324	got=[] expected=['<s>', '<s>', '<s>', '<s>']
- 28784	got=[] expected=['<s>', '<s>', '<s>', '<s>', '<s>', '<s>']
- 28652	got=[] expected=['<s>', '<s>', '<s>', '<s>', '<s>', '<s>', '<s>', '<s>']
- 15064	got=[] expected=['<s>', '<s>', '<s>', '<s>', '<s>']
- 13496	got=[] expected=['<s>', '<s>', '<s>']
