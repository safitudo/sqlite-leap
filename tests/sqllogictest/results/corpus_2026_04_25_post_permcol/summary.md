# Corpus run 2026-04-25 post-permcol-fix (Rust)
...
- 7474	compile: JOIN requires multi-schema compile path; use compile_select_multi
...
- 3082	compile: deferred: DISTINCT across JOIN sources
- 2564	compile: projection references column not in GROUP BY
- 1559	compile: deferred: qualified column ref `x.b` in SELECT
- 992	compile: deferred: CAST DECIMAL
- 792	compile: deferred: qualified column ref `x.c` in SELECT
...
- 4445	got(<n>)=["<s>", "<s>", "<s>", "<s>", "<s>", "<s>", "<s>", "<s>"] expected(<n>)=[]
- 3420	install: table "<s>" already exists
...
- select5.test	0.0%	0	640	796	OK
- evidence/slt_lang_replace.test	0.0%	0	5	9	OK
- select4.test	0.0%	0	1000	2857	OK
- evidence/slt_lang_aggfunc.test	2.5%	2	9	69	OK
- evidence/slt_lang_createtrigger.test	3.8%	1	3	22	OK
...
- evidence/slt_lang_update.test	7.4%	2	3	22	OK
...
- evidence/slt_lang_reindex.test	14.3%	1	3	3	OK
...
- evidence/slt_lang_dropview.test	15.4%	2	3	8	OK
...
- select2.test	19.5%	201	416	414	OK
- select3.test	20.1%	675	1154	1522	OK
...
- evidence/slt_lang_droptable.test	25.0%	3	3	6	OK
- evidence/slt_lang_dropindex.test	25.0%	2	3	3	OK
- evidence/slt_lang_droptrigger.test	25.0%	3	3	6	OK
...
- select1.test	38.6%	398	218	415	OK
...
- evidence/slt_lang_createview.test	40.0%	10	3	12	OK
...
- evidence/in2.test	98.1%	53	0	1	OK
