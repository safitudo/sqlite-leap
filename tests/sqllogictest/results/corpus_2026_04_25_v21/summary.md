...
| c | 1466223 | 64 | 4206 | 83229 | 1553722 | 94.37% | 99.71% |
| go | 1504995 | 379 | 19146 | 83741 | 1608261 | 93.58% | 98.72% |
| zig | 1565022 | 1923 | 23974 | 99785 | 1690704 | 92.57% | 98.37% |
| python | 1487225 | 6229 | 115182 | 134851 | 1743487 | 85.30% | 92.45% |
...
- 4326	compile: deferred: GROUP BY
...
- 29769	statement: unsupported leading kw '<s>'
...
### zig
- 709	got(<n>) expected(<n>) first got=<n> expected=<n>
- 627	got(<n>) expected(<n>) first got=-<n> expected=-<n>
...
### python
- 2667	got(<n>)=['<s>', '<s>', '<s>', '<s>', '<s>', '<s>', '<s>', '<s>'] expected(<n>)=[]
- 811	install: table '<s>' already exists
- 619	got(<n>)=['<s>', '<s>', '<s>', '<s>', '<s>', '<s>', '<s>', '<s>'] expected(<n>)=['<s>']
- 345	got(<n>)=['<s>', '<s>', '<s>', '<s>', '<s>', '<s>', '<s>', '<s>'] expected(<n>)=['<s>', '<s>', '<s>']
- 340	got(<n>)=['<s>', '<s>', '<s>', '<s>', '<s>', '<s>', '<s>', '<s>'] expected(<n>)=['<s>', '<s>', '<s>', '<s>', '<s>', '<s>...
- 322	got(<n>)=['<s>', '<s>', '<s>', '<s>', '<s>', '<s>', '<s>', '<s>'] expected(<n>)=['<s>', '<s>']
- 198	got(<n>)=['<s>', '<s>', '<s>', '<s>', '<s>', '<s>', '<s>', '<s>'] expected(<n>)=['<s>', '<s>', '<s>', '<s>']
- 180	got(<n>)=['<s>', '<s>', '<s>', '<s>', '<s>', '<s>', '<s>', '<s>'] expected(<n>)=['<s>', '<s>', '<s>', '<s>', '<s>']
- 65	got(<n>)=['<s>', '<s>', '<s>', '<s>'] expected(<n>)=[]
- 62	got(<n>)=['<s>'] expected(<n>)=[]
