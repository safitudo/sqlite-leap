...
| --- | --- | --- | --- | --- | --- | --- | --- |
| rust | 1619269 | 174 | 48 | 123255 | 1742746 | 92.91% | 99.99% |
| c | 1519963 | 60 | 42 | 83252 | 1603317 | 94.80% | 99.99% |
| go | 1513183 | 321 | 30 | 83028 | 1596562 | 94.78% | 99.98% |
...
- 2	compile: deferred: qualified column ref `cor0.col0` in SELECT
...
- 5	execute: trigger drop: TriggerNotFound
...
- 3	hash mismatch: count got=<n> expected=<n>, md5 got=00df66cefa156cd606d94938da3f7118 expected=1a92b418ae3c05ba566f88a890a...
- 3	hash mismatch: count got=<n> expected=<n>, md5 got=6cc60f5beeed2009ec2712a51cc39755 expected=deaaa983f771be544ffdc26f04a...
